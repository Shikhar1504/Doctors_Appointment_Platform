    ...
    <div className="bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          ></div>
          <div
            className="absolute top-3/4 left-1/2 w-64 h-64 bg-primary/15 rounded-full blur-2xl animate-pulse"
        ...
        <div className="container mx-auto px-4 relative z-20">
          <div className="text-center space-y-12">
            {/* Brand Announcement */}
            <div className="inline-flex items-center gap-3 px-6 py-2 bg-card/80 backdrop-blur-sm rounded-full border border-primary/20 shadow-lg">
              ...
              <span className="text-sm font-medium text-muted-foreground">
                🚀 Trusted by 50,000+ patients worldwide - Join the healthcare
                revolution
              </span>
            </div>
            ...
            <div className="space-y-6 max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black leading-tight">
                <span className="gradient-title text-5xl md:text-7xl lg:text-8xl">
                  CareMeet
                </span>
                <br />
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Connect with certified doctors through video consultations, get
                AI-powered health insights, and manage your wellness journey—all
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              <div className="group bg-card/50 backdrop-blur-sm rounded-2xl p-6 border border-primary/20 hover:border-primary/40 transition-all duration-300 hover:scale-105">
                ...
                <p className="text-sm text-muted-foreground">
                  Connect with board-certified doctors through secure video
                  calls
                </p>
              </div>
              ...
              <div className="group bg-card/50 backdrop-blur-sm rounded-2xl p-6 border border-primary/20 hover:border-accent/40 transition-all duration-300 hover:scale-105">
                ...
                <p className="text-sm text-muted-foreground">
                  Advanced symptom analysis with personalized health
                  recommendations
                </p>
              </div>
        ...
        <div
          className="absolute top-40 right-32 w-14 h-14 bg-accent/20 rounded-2xl flex items-center justify-center animate-float"
          style={{ animationDelay: "1s" }}
        >
          <svg
        ...
        <div
          className="absolute bottom-32 left-32 w-12 h-12 bg-primary/20 rounded-xl flex items-center justify-center animate-float"
          style={{ animationDelay: "2s" }}
        >
          <svg
        ...
        <div
          className="absolute bottom-20 right-20 w-18 h-18 bg-accent/20 rounded-2xl flex items-center justify-center animate-float"
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Experience the future of medicine with our advanced AI that
                  understands your symptoms, recommends evidence-based
                  treatments, and instantly connects you with specialist
                  doctors.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="group flex items-start gap-4 p-4 rounded-2xl border border-primary/20 hover:border-primary/40 transition-all hover:bg-primary/5">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Our medical AI evaluates your symptoms using clinical
                      protocols and provides evidence-based preliminary
                ...
                <div className="group flex items-start gap-4 p-4 rounded-2xl border border-accent/20 hover:border-accent/40 transition-all hover:bg-accent/5">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground mb-2">
                      Precision Doctor Matching
                    </h3>
                    <p className="text-muted-foreground">
                      Advanced matching algorithm connects you with
                      board-certified specialists who have the exact expertise
                      for your condition.
                    </p>
                  </div>
                </div>
                ...
                <div className="group flex items-start gap-4 p-4 rounded-2xl border border-primary/20 hover:border-primary/40 transition-all hover:bg-primary/5">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Receive tailored health recommendations, track wellness
                      patterns, and get proactive insights to optimize your
                      long-term health.
                    </p>
                  </div>
                </div>
      ...
      <section
        id="pricing"
        className="py-20 bg-gradient-to-br from-background via-accent/5 to-primary/5 relative overflow-hidden"
      >
        {/* Background Elements */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16 animate-slide-in-up">
            ...
            <h2 className="heading-medical text-foreground mb-4">
              <span className="gradient-title">CareMeet</span> Consultation
              Packages
            </h2>
              ...
              <div className="grid lg:grid-cols-12 gap-8 items-center">
                ...
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <p className="subheading-medical mb-6">
                    ...
                    journey with CareMeet. Get started today and experience
